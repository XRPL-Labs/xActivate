...
export default function ActionSecondary(props: ActionProps) {
    return (
        <div onClick={() => props.onClick()} className="w-full button bg-[rgb(var(--colorLight))] rounded-[20px] text-secondary flex items-center justify-center gap-5 pl-[25px] pr-4">
