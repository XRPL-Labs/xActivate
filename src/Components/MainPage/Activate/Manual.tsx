        ...
        <>
            {props.useExchange === true ?
                ...
                props.useAccount === true ?
                    <>
                        <AccountActivation style={props.props.xAppStyle} xumm={props.xumm} nodewss={props.nodewss} accountToActivate={props.accountToActivate} setUseAccount={props.setUseAccount} />
